    ...
    <form onSubmit={form.onSubmit(onSubmit)}>
      ...
      <Stack gap="lg">
        <Stack gap="md">
          <TextInput
            label="Name"
            placeholder="How would you like us to refer to you?"
        ...
        <Card bg="var(--mantine-color-dark-6)" withBorder>
          <Stack gap="md">
            ...
            <Text>
              Your expression of interest will be used in the following ways:
            </Text>
            <List>
              <List.Item>
                <Text>
                  <strong>Email address:</strong> Used to send you an automated
                  email with links allowing you to edit or delete your
                  expression of interest.
                </Text>
              </List.Item>
              <List.Item>
                <Text>
                  <strong>Other fields:</strong> Displayed to all current and
                  future participants in the collective so that they can opt-in
                  to following up on your interest.
                </Text>
              </List.Item>
            </List>
            <Text>
              Your data will be permanently deleted when any one of the
              following occurs:
            </Text>
            <List>
              <List.Item>
                <Text>
                  <strong>You request deletion:</strong> If you decide to
                  withdraw your expression of interest using the provided link,
                  all of your data will be permanently deleted.
                </Text>
              </List.Item>
              <List.Item>
                <Text>
                  <strong>You're invited:</strong> If you are invited to
                  participate in the collective, your expression of interest
                  will be deleted.
                </Text>
              </List.Item>
              <List.Item>
                <Text>
                  <strong>One year has passed:</strong> Your expression of
                  interest will be automatically deleted one year after
                  submission.
                </Text>
              </List.Item>
            </List>
