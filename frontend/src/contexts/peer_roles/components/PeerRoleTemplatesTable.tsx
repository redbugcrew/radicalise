...
import type { PeerRoleTemplate } from "../../../../api/Api";
import { Anchor } from "../../../../components";

interface PeerRoleTemplatesTableProps {
  eventTemplates: PeerRoleTemplate[];
}

function PeerRoleTemplateTableRow({
  template,
}: {
...
export default function PeerRoleTemplatesTable({
  peerroleTemplates,
}: PeerRoleTemplatesTableProps) {
  return (
    <Table>
      <Table.Thead>
        <Table.Tr>
